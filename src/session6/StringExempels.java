...
//        stringMethods();
    ...
    public static void stringOperators() {
        ...
        code4 += 12;
        System.out.println("valoarea lui code4 este " + code4);
    ...
    public static void stringMethods() {
        ...
        System.out.println("subdtring din str1: " + str1.substring(3));
        ...
        System.out.println("ends witg ld? " + str1.endsWith("ld"));
